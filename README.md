...
## Installation
You can simply clone this reposity and run the script using `python3 main.py`, assuming you have a [CFBD API key](https://collegefootballdata.com/key), created a .env file with a `api-token='<API-KEY>'` entry, and have installed the following packages:
- [CFBD](https://pypi.org/project/cfbd/)
